...
```
dotnet run --project Iex.IexEquities.Tops.IexTp.v1.66/Test/Iex.IexEquities.Tops.IexTp.v1.66.Test.csproj -- <path-to-pcap>
```
...
Produces `Iex.IexEquities.Tops.IexTp.v1.66.ZeroCopy.1.66.0.nupkg`.

## Portability

The packable library `Iex.IexEquities.Tops.IexTp.v1.66.ZeroCopy` is fully self-contained. The Test and example harness projects additionally reference the `ZeroCopy/Pcap.CSharp` support project by relative path.
