...
/// <summary>
///  Represents the OperationalHaltStatusMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
...
public sealed class OperationalHaltStatusMessage : IMessage, IEquatable<OperationalHaltStatusMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'O';
    ...
    /// </summary>
    public OperationalHaltStatusField OperationalHaltStatus { get; set; } = new();
    ...
    /// <summary>
    ///  Initializes a new <see cref="OperationalHaltStatusMessage"/> with all fields at their default values.
    /// </summary>
    public OperationalHaltStatusMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="OperationalHaltStatusMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public OperationalHaltStatusMessage(OperationalHaltStatusMessage other) : this()
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other.Raw is { } raw) Raw = raw.ToArray();
        IsDecoded = other.IsDecoded;
        OperationalHaltStatus.CopyFrom(other.OperationalHaltStatus);
        Timestamp.CopyFrom(other.Timestamp);
        Symbol.CopyFrom(other.Symbol);
    }

    /// <summary>
    ///  Parses a <see cref="OperationalHaltStatusMessage"/> from a binary data span at the given offset.
    ...
    public OperationalHaltStatusMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="OperationalHaltStatusMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    /// <returns>A new <see cref="OperationalHaltStatusMessage"/> with all fields populated from the binary data.</returns>
    public static OperationalHaltStatusMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new OperationalHaltStatusMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="OperationalHaltStatusMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="OperationalHaltStatusMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    {
        offset = OperationalHaltStatus.Encode(data, offset);
    ...
    /// <summary>
    ///  Encodes this <see cref="OperationalHaltStatusMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="OperationalHaltStatusMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static OperationalHaltStatusMessage Sample()
    {
        var msg = new OperationalHaltStatusMessage();
        msg.OperationalHaltStatus = OperationalHaltStatusField.Sample(seed: 0);
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="OperationalHaltStatusMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="OperationalHaltStatusMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(OperationalHaltStatusMessage? other)
    {
        if (other is null) return false;
        if (!OperationalHaltStatus.Equals(other.OperationalHaltStatus)) return false;
    ...
    /// <summary>
    ///  Compares two <see cref="OperationalHaltStatusMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is OperationalHaltStatusMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="OperationalHaltStatusMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    public override int GetHashCode()
    {
        var hash = new HashCode();
        hash.Add(OperationalHaltStatus);
        hash.Add(Timestamp);
        hash.Add(Symbol);
        return hash.ToHashCode();
    }

    public static bool operator ==(OperationalHaltStatusMessage? a, OperationalHaltStatusMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(OperationalHaltStatusMessage? a, OperationalHaltStatusMessage? b) => !(a == b);
    ...
    public readonly struct Changes : IEquatable<Changes>
    {
        ...
        public override string ToString()
        {
            ...
            var first = true;
            if (Has(0)) { if (!first) sb.Append(", "); sb.Append("OperationalHaltStatus"); first = false; }
    ...
    public Changes Diff(OperationalHaltStatusMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var diff = Changes.None;
        if (!OperationalHaltStatus.Equals(other.OperationalHaltStatus)) diff = diff.With(0);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not OperationalHaltStatusMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(OperationalHaltStatusMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var changes = Diff(other);
        if (changes.IsNone) yield break;
        if (changes.Has(0)) yield return (OperationalHaltStatus.Name, OperationalHaltStatus.ToFormattedString(), other.OperationalHaltStatus.ToFormattedString());
    ...
    public IEnumerable<Field> Fields
    {
        get
        {
            yield return OperationalHaltStatus;
    ...
    {
        FieldName.OperationalHaltStatus => OperationalHaltStatus,
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="OperationalHaltStatusMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("OperationalHaltStatusMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="OperationalHaltStatusMessage"/>,
    ...
    public string ToFormattedString(PrintOptions options = default)
    {
        if (options.IsIdentifier)
            return $"[{MessageType}] [{OperationalHaltStatus.Value}] [{Timestamp.Value}] [{Symbol.Value}]";
        if (options.IsCompact)
        {
            var sb = new StringBuilder();
            sb.Append("OperationalHaltStatusMessage { ");
            bool first = true;
            foreach (var f in Fields)
            {
                if (!first) sb.Append(", ");
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="OperationalHaltStatusMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="OperationalHaltStatusMessage"/>.
    /// </summary>
