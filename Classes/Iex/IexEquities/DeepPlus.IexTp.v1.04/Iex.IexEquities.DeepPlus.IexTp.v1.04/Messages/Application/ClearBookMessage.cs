...
/// <summary>
///  Represents the ClearBookMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
...
public sealed class ClearBookMessage : IMessage, IEquatable<ClearBookMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'C';
    ...
    /// <summary>
    ///  Initializes a new <see cref="ClearBookMessage"/> with all fields at their default values.
    /// </summary>
    public ClearBookMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="ClearBookMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public ClearBookMessage(ClearBookMessage other) : this()
    {
    ...
    /// <summary>
    ///  Parses a <see cref="ClearBookMessage"/> from a binary data span at the given offset.
    ...
    public ClearBookMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="ClearBookMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    /// <returns>A new <see cref="ClearBookMessage"/> with all fields populated from the binary data.</returns>
    public static ClearBookMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new ClearBookMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="ClearBookMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="ClearBookMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    /// <summary>
    ///  Encodes this <see cref="ClearBookMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="ClearBookMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static ClearBookMessage Sample()
    {
        var msg = new ClearBookMessage();
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="ClearBookMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="ClearBookMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(ClearBookMessage? other)
    {
    ...
    /// <summary>
    ///  Compares two <see cref="ClearBookMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is ClearBookMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="ClearBookMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(ClearBookMessage? a, ClearBookMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(ClearBookMessage? a, ClearBookMessage? b) => !(a == b);
    ...
    public Changes Diff(ClearBookMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not ClearBookMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(ClearBookMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="ClearBookMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("ClearBookMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="ClearBookMessage"/>,
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="ClearBookMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="ClearBookMessage"/>.
    /// </summary>
