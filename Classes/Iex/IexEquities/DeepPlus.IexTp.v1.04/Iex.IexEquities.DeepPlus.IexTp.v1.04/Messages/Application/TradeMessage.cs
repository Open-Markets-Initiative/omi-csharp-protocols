...
/// <summary>
///  Represents the TradeMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
...
public sealed class TradeMessage : IMessage, IEquatable<TradeMessage>
{
    /// <summary>
    ...
    /// <summary>
    ///  Initializes a new <see cref="TradeMessage"/> with all fields at their default values.
    /// </summary>
    public TradeMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="TradeMessage"/> from an existing instance, copying all field values.
    /// </summary>
    ...
    /// <summary>
    ///  Parses a <see cref="TradeMessage"/> from a binary data span at the given offset.
    ...
    public TradeMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="TradeMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    /// <returns>A new <see cref="TradeMessage"/> with all fields populated from the binary data.</returns>
    public static TradeMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new TradeMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="TradeMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="TradeMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static TradeMessage Sample()
    {
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="TradeMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="TradeMessage"/> to another using field-by-field comparison.
    /// </summary>
    ...
    /// <summary>
    ///  Compares two <see cref="TradeMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is TradeMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="TradeMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(TradeMessage? a, TradeMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(TradeMessage? a, TradeMessage? b) => !(a == b);
    ...
    public Changes Diff(TradeMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not TradeMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(TradeMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="TradeMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("TradeMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="TradeMessage"/>,
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="TradeMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="TradeMessage"/>.
    /// </summary>
