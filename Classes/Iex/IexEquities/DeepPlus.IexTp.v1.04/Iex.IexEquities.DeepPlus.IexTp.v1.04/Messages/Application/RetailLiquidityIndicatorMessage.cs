...
/// <summary>
///  Represents the RetailLiquidityIndicatorMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
...
public sealed class RetailLiquidityIndicatorMessage : IMessage, IEquatable<RetailLiquidityIndicatorMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'I';
    ...
    /// </summary>
    public RetailLiquidityIndicatorField RetailLiquidityIndicator { get; set; } = new();
    ...
    /// <summary>
    ///  Initializes a new <see cref="RetailLiquidityIndicatorMessage"/> with all fields at their default values.
    /// </summary>
    public RetailLiquidityIndicatorMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="RetailLiquidityIndicatorMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public RetailLiquidityIndicatorMessage(RetailLiquidityIndicatorMessage other) : this()
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other.Raw is { } raw) Raw = raw.ToArray();
        IsDecoded = other.IsDecoded;
        RetailLiquidityIndicator.CopyFrom(other.RetailLiquidityIndicator);
        Timestamp.CopyFrom(other.Timestamp);
        Symbol.CopyFrom(other.Symbol);
    }

    /// <summary>
    ///  Parses a <see cref="RetailLiquidityIndicatorMessage"/> from a binary data span at the given offset.
    ...
    public RetailLiquidityIndicatorMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="RetailLiquidityIndicatorMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    /// <returns>A new <see cref="RetailLiquidityIndicatorMessage"/> with all fields populated from the binary data.</returns>
    public static RetailLiquidityIndicatorMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new RetailLiquidityIndicatorMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="RetailLiquidityIndicatorMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 17 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="RetailLiquidityIndicatorMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    {
        offset = RetailLiquidityIndicator.Encode(data, offset);
    ...
    /// <summary>
    ///  Encodes this <see cref="RetailLiquidityIndicatorMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="RetailLiquidityIndicatorMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static RetailLiquidityIndicatorMessage Sample()
    {
        var msg = new RetailLiquidityIndicatorMessage();
        msg.RetailLiquidityIndicator = RetailLiquidityIndicatorField.Sample(seed: 0);
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="RetailLiquidityIndicatorMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="RetailLiquidityIndicatorMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(RetailLiquidityIndicatorMessage? other)
    {
        if (other is null) return false;
        if (!RetailLiquidityIndicator.Equals(other.RetailLiquidityIndicator)) return false;
    ...
    /// <summary>
    ///  Compares two <see cref="RetailLiquidityIndicatorMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is RetailLiquidityIndicatorMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="RetailLiquidityIndicatorMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    public override int GetHashCode()
    {
        var hash = new HashCode();
        hash.Add(RetailLiquidityIndicator);
        hash.Add(Timestamp);
        hash.Add(Symbol);
        return hash.ToHashCode();
    }

    public static bool operator ==(RetailLiquidityIndicatorMessage? a, RetailLiquidityIndicatorMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(RetailLiquidityIndicatorMessage? a, RetailLiquidityIndicatorMessage? b) => !(a == b);
    ...
    public readonly struct Changes : IEquatable<Changes>
    {
        ...
        public override string ToString()
        {
            ...
            var first = true;
            if (Has(0)) { if (!first) sb.Append(", "); sb.Append("RetailLiquidityIndicator"); first = false; }
    ...
    public Changes Diff(RetailLiquidityIndicatorMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var diff = Changes.None;
        if (!RetailLiquidityIndicator.Equals(other.RetailLiquidityIndicator)) diff = diff.With(0);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not RetailLiquidityIndicatorMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(RetailLiquidityIndicatorMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var changes = Diff(other);
        if (changes.IsNone) yield break;
        if (changes.Has(0)) yield return (RetailLiquidityIndicator.Name, RetailLiquidityIndicator.ToFormattedString(), other.RetailLiquidityIndicator.ToFormattedString());
    ...
    public IEnumerable<Field> Fields
    {
        get
        {
            yield return RetailLiquidityIndicator;
    ...
    {
        FieldName.RetailLiquidityIndicator => RetailLiquidityIndicator,
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="RetailLiquidityIndicatorMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("RetailLiquidityIndicatorMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="RetailLiquidityIndicatorMessage"/>,
    ...
    public string ToFormattedString(PrintOptions options = default)
    {
        if (options.IsIdentifier)
            return $"[{MessageType}] [{RetailLiquidityIndicator.Value}] [{Timestamp.Value}] [{Symbol.Value}]";
        if (options.IsCompact)
        {
            var sb = new StringBuilder();
            sb.Append("RetailLiquidityIndicatorMessage { ");
            bool first = true;
            foreach (var f in Fields)
            {
                if (!first) sb.Append(", ");
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="RetailLiquidityIndicatorMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="RetailLiquidityIndicatorMessage"/>.
    /// </summary>
