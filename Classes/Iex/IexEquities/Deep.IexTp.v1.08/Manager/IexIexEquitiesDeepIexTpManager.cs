...
public sealed partial class IexIexEquitiesDeepIexTpManager
{
    ...
    void Dispatch(IMessage message, int seq)
    {
        switch (message)
        {
            ...
            case PriceLevelBuyUpdateMessage msg:
                OnPriceLevelBuyUpdateMessage(msg, seq);
                break;
            case PriceLevelSellUpdateMessage msg:
                OnPriceLevelSellUpdateMessage(msg, seq);
                break;
    ...
    /// <summary>
    ///  Called for each <c>PriceLevelBuyUpdateMessage</c> message. Add handler logic in the implementing
    ///  partial. Unimplemented partials are elided by the compiler.
    /// </summary>
    partial void OnPriceLevelBuyUpdateMessage(PriceLevelBuyUpdateMessage msg, int seq);

    /// <summary>
    ///  Called for each <c>PriceLevelSellUpdateMessage</c> message. Add handler logic in the implementing
    ///  partial. Unimplemented partials are elided by the compiler.
    /// </summary>
    partial void OnPriceLevelSellUpdateMessage(PriceLevelSellUpdateMessage msg, int seq);
