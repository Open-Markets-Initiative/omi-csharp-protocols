...
/// <summary>
///  Represents the PriceLevelSellUpdateMessage from the Deep protocol.
/// </summary>
/// <remarks>
...
public sealed class PriceLevelSellUpdateMessage : IMessage, IEquatable<PriceLevelSellUpdateMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = '5';

    /// <summary>
    ///  Total fixed byte length of this message.
    /// </summary>
    private const int MessageByteLength = 29;

    /// <summary>
    ///  Identifies event processing by the System
    /// </summary>
    public EventFlagsField EventFlags { get; set; } = new();
    ...
    /// <summary>
    ///  The total fixed byte length of this message (29 bytes).
    /// </summary>
    ...
    /// <summary>
    ///  Initializes a new <see cref="PriceLevelSellUpdateMessage"/> with all fields at their default values.
    /// </summary>
    public PriceLevelSellUpdateMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="PriceLevelSellUpdateMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public PriceLevelSellUpdateMessage(PriceLevelSellUpdateMessage other) : this()
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other.Raw is { } raw) Raw = raw.ToArray();
        IsDecoded = other.IsDecoded;
        EventFlags.CopyFrom(other.EventFlags);
    ...
    /// <summary>
    ///  Parses a <see cref="PriceLevelSellUpdateMessage"/> from a binary data span at the given offset.
    ...
    public PriceLevelSellUpdateMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="PriceLevelSellUpdateMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 29 bytes.</param>
    /// <returns>A new <see cref="PriceLevelSellUpdateMessage"/> with all fields populated from the binary data.</returns>
    public static PriceLevelSellUpdateMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new PriceLevelSellUpdateMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="PriceLevelSellUpdateMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 29 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="PriceLevelSellUpdateMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    /// <param name="data">The destination span. Must be at least offset + 29 bytes.</param>
    ...
    {
        offset = EventFlags.Encode(data, offset);
    ...
    /// <summary>
    ///  Encodes this <see cref="PriceLevelSellUpdateMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    /// <param name="data">The destination span. Must be at least 29 bytes.</param>
    /// <returns>The offset after the last written byte.</returns>
    public int Encode(Span<byte> data) => Encode(data, 0);

    /// <summary>
    ///  Returns a <see cref="PriceLevelSellUpdateMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static PriceLevelSellUpdateMessage Sample()
    {
        var msg = new PriceLevelSellUpdateMessage();
        msg.EventFlags = EventFlagsField.Sample(seed: 0);
        msg.Timestamp = TimestampField.Sample(seed: 1);
        msg.Symbol = SymbolField.Sample(seed: 2);
        msg.Size = SizeField.Sample(seed: 3);
        msg.Price = PriceField.Sample(seed: 4);
        return msg;
    }
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="PriceLevelSellUpdateMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="PriceLevelSellUpdateMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(PriceLevelSellUpdateMessage? other)
    {
        if (other is null) return false;
        if (!EventFlags.Equals(other.EventFlags)) return false;
    ...
    /// <summary>
    ///  Compares two <see cref="PriceLevelSellUpdateMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is PriceLevelSellUpdateMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="PriceLevelSellUpdateMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(PriceLevelSellUpdateMessage? a, PriceLevelSellUpdateMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(PriceLevelSellUpdateMessage? a, PriceLevelSellUpdateMessage? b) => !(a == b);
    ...
    public readonly struct Changes : IEquatable<Changes>
    {
        ...
        public override string ToString()
        {
            ...
            var first = true;
            if (Has(0)) { if (!first) sb.Append(", "); sb.Append("EventFlags"); first = false; }
            if (Has(1)) { if (!first) sb.Append(", "); sb.Append("Timestamp"); first = false; }
            if (Has(2)) { if (!first) sb.Append(", "); sb.Append("Symbol"); first = false; }
            if (Has(3)) { if (!first) sb.Append(", "); sb.Append("Size"); first = false; }
            if (Has(4)) { if (!first) sb.Append(", "); sb.Append("Price"); first = false; }
            return sb.ToString();
        }
    }
    ...
    public Changes Diff(PriceLevelSellUpdateMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var diff = Changes.None;
        if (!EventFlags.Equals(other.EventFlags)) diff = diff.With(0);
        if (!Timestamp.Equals(other.Timestamp)) diff = diff.With(1);
        if (!Symbol.Equals(other.Symbol)) diff = diff.With(2);
        if (!Size.Equals(other.Size)) diff = diff.With(3);
        if (!Price.Equals(other.Price)) diff = diff.With(4);
        return diff;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not PriceLevelSellUpdateMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
        var changes = Diff(typed);
        const ulong FieldMaskW0 = 0x000000000000001FUL;
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(PriceLevelSellUpdateMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var changes = Diff(other);
        if (changes.IsNone) yield break;
        if (changes.Has(0)) yield return (EventFlags.Name, EventFlags.ToFormattedString(), other.EventFlags.ToFormattedString());
        ...
        if (changes.Has(3)) yield return (Size.Name, Size.ToFormattedString(), other.Size.ToFormattedString());
        if (changes.Has(4)) yield return (Price.Name, Price.ToFormattedString(), other.Price.ToFormattedString());
    }
    ...
    {
        FieldName.EventFlags => EventFlags,
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="PriceLevelSellUpdateMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("PriceLevelSellUpdateMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="PriceLevelSellUpdateMessage"/>,
    ...
    public string ToFormattedString(PrintOptions options = default)
    {
        if (options.IsIdentifier)
            return $"[{MessageType}] [{EventFlags.Value}] [{Timestamp.Value}] [{Symbol.Value}]";
        if (options.IsCompact)
        {
            var sb = new StringBuilder();
            sb.Append("PriceLevelSellUpdateMessage { ");
            bool first = true;
            foreach (var f in Fields)
            {
                if (!first) sb.Append(", ");
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="PriceLevelSellUpdateMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="PriceLevelSellUpdateMessage"/>.
    /// </summary>
