...
public sealed class ReferencePriceField : Field, IEquatable<ReferencePriceField>, IComparable<ReferencePriceField>
{
    public const int ByteLength = 8;
    public const bool IsLittleEndian = true;
    public const long Factor = 10000;

    public override string Name => "ReferencePrice";
    ...
    public void CopyFrom(ReferencePriceField other)
    {
    ...
    public static ReferencePriceField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(ReferencePriceField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is ReferencePriceField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(ReferencePriceField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(ReferencePriceField? a, ReferencePriceField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(ReferencePriceField? a, ReferencePriceField? b) => !(a == b);

    public static implicit operator decimal(ReferencePriceField field) => field.Value;
    public static implicit operator ReferencePriceField(decimal value) => new() { Value = value };

    public static bool operator ==(ReferencePriceField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, ReferencePriceField? b) => b is not null && b.Value == a;
    public static bool operator !=(ReferencePriceField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, ReferencePriceField? b) => !(a == b);

    public static bool operator <(ReferencePriceField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, ReferencePriceField? b) => b is not null && a < b.Value;
    public static bool operator >(ReferencePriceField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, ReferencePriceField? b) => b is not null && a > b.Value;
    public static bool operator <=(ReferencePriceField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, ReferencePriceField? b) => b is not null && a <= b.Value;
