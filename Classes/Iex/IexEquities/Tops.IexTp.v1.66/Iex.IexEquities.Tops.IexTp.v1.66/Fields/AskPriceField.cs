...
public sealed class AskPriceField : Field, IEquatable<AskPriceField>, IComparable<AskPriceField>
{
    public const int ByteLength = 8;
    public const bool IsLittleEndian = true;
    public const long Factor = 10000;

    public override string Name => "AskPrice";
    ...
    public void CopyFrom(AskPriceField other)
    {
    ...
    public static AskPriceField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(AskPriceField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is AskPriceField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(AskPriceField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(AskPriceField? a, AskPriceField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(AskPriceField? a, AskPriceField? b) => !(a == b);

    public static implicit operator decimal(AskPriceField field) => field.Value;
    public static implicit operator AskPriceField(decimal value) => new() { Value = value };

    public static bool operator ==(AskPriceField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, AskPriceField? b) => b is not null && b.Value == a;
    public static bool operator !=(AskPriceField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, AskPriceField? b) => !(a == b);

    public static bool operator <(AskPriceField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, AskPriceField? b) => b is not null && a < b.Value;
    public static bool operator >(AskPriceField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, AskPriceField? b) => b is not null && a > b.Value;
    public static bool operator <=(AskPriceField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, AskPriceField? b) => b is not null && a <= b.Value;
