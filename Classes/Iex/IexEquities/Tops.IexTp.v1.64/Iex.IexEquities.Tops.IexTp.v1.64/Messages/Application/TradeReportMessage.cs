...
/// <summary>
///  Represents the TradeReportMessage from the Tops protocol.
/// </summary>
/// <remarks>
...
public sealed class TradeReportMessage : IMessage, IEquatable<TradeReportMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'T';

    /// <summary>
    ///  Total fixed byte length of this message.
    /// </summary>
    private const int MessageByteLength = 37;
    ...
    /// <summary>
    ///  The total fixed byte length of this message (37 bytes).
    /// </summary>
    ...
    /// <summary>
    ///  Initializes a new <see cref="TradeReportMessage"/> with all fields at their default values.
    /// </summary>
    public TradeReportMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="TradeReportMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public TradeReportMessage(TradeReportMessage other) : this()
    {
    ...
    /// <summary>
    ///  Parses a <see cref="TradeReportMessage"/> from a binary data span at the given offset.
    ...
    public TradeReportMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="TradeReportMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    /// <returns>A new <see cref="TradeReportMessage"/> with all fields populated from the binary data.</returns>
    public static TradeReportMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new TradeReportMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="TradeReportMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeReportMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    /// <param name="data">The destination span. Must be at least offset + 37 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeReportMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    /// <param name="data">The destination span. Must be at least 37 bytes.</param>
    /// <returns>The offset after the last written byte.</returns>
    public int Encode(Span<byte> data) => Encode(data, 0);

    /// <summary>
    ///  Returns a <see cref="TradeReportMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static TradeReportMessage Sample()
    {
        var msg = new TradeReportMessage();
        ...
        msg.TradeId = TradeIdField.Sample(seed: 5);
        return msg;
    }
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="TradeReportMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="TradeReportMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(TradeReportMessage? other)
    {
    ...
    /// <summary>
    ///  Compares two <see cref="TradeReportMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is TradeReportMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="TradeReportMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(TradeReportMessage? a, TradeReportMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(TradeReportMessage? a, TradeReportMessage? b) => !(a == b);
    ...
    public readonly struct Changes : IEquatable<Changes>
    {
        ...
        public override string ToString()
        {
            ...
            if (Has(5)) { if (!first) sb.Append(", "); sb.Append("TradeId"); first = false; }
            return sb.ToString();
        }
    }
    ...
    public Changes Diff(TradeReportMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        ...
        if (!TradeId.Equals(other.TradeId)) diff = diff.With(5);
        return diff;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not TradeReportMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(TradeReportMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        ...
        if (changes.Has(5)) yield return (TradeId.Name, TradeId.ToFormattedString(), other.TradeId.ToFormattedString());
    }
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="TradeReportMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("TradeReportMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="TradeReportMessage"/>,
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="TradeReportMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="TradeReportMessage"/>.
    /// </summary>
