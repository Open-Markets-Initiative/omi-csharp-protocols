...
public sealed class PriceField : Field, IEquatable<PriceField>, IComparable<PriceField>
{
    ...
    public void CopyFrom(PriceField other)
    {
    ...
    public static PriceField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(PriceField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is PriceField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(PriceField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(PriceField? a, PriceField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(PriceField? a, PriceField? b) => !(a == b);

    public static implicit operator decimal(PriceField field) => field.Value;
    public static implicit operator PriceField(decimal value) => new() { Value = value };

    public static bool operator ==(PriceField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, PriceField? b) => b is not null && b.Value == a;
    public static bool operator !=(PriceField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, PriceField? b) => !(a == b);

    public static bool operator <(PriceField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, PriceField? b) => b is not null && a < b.Value;
    public static bool operator >(PriceField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, PriceField? b) => b is not null && a > b.Value;
    public static bool operator <=(PriceField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, PriceField? b) => b is not null && a <= b.Value;
