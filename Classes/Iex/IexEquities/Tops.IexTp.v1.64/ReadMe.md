...
```
dotnet run --project Test/Iex.IexEquities.Tops.IexTp.v1.64.Test.csproj -- <path-to-pcap>
```
...
Produces `Iex.IexEquities.Tops.IexTp.v1.64.Classes.1.64.0.nupkg`.

## Portability

The packable library `Iex.IexEquities.Tops.IexTp.v1.64.Classes` is fully self-contained. The Test and example harness projects additionally reference the `Classes/Pcap.CSharp` support project by relative path.
