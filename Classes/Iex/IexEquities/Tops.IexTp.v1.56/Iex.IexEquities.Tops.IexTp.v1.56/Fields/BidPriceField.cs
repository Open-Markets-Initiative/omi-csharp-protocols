...
public sealed class BidPriceField : Field, IEquatable<BidPriceField>, IComparable<BidPriceField>
{
    public const int ByteLength = 8;
    public const bool IsLittleEndian = true;
    public const long Factor = 10000;

    public override string Name => "BidPrice";
    ...
    public void CopyFrom(BidPriceField other)
    {
    ...
    public static BidPriceField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(BidPriceField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is BidPriceField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(BidPriceField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(BidPriceField? a, BidPriceField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(BidPriceField? a, BidPriceField? b) => !(a == b);

    public static implicit operator decimal(BidPriceField field) => field.Value;
    public static implicit operator BidPriceField(decimal value) => new() { Value = value };

    public static bool operator ==(BidPriceField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, BidPriceField? b) => b is not null && b.Value == a;
    public static bool operator !=(BidPriceField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, BidPriceField? b) => !(a == b);

    public static bool operator <(BidPriceField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, BidPriceField? b) => b is not null && a < b.Value;
    public static bool operator >(BidPriceField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, BidPriceField? b) => b is not null && a > b.Value;
    public static bool operator <=(BidPriceField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, BidPriceField? b) => b is not null && a <= b.Value;
