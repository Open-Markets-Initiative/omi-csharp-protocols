...
```
dotnet run --project Test/Iex.IexEquities.Tops.IexTp.v1.56.Test.csproj -- <path-to-pcap>
```
...
Produces `Iex.IexEquities.Tops.IexTp.v1.56.Classes.1.56.0.nupkg`.

## Portability

The packable library `Iex.IexEquities.Tops.IexTp.v1.56.Classes` is fully self-contained. The Test and example harness projects additionally reference the `Classes/Pcap.CSharp` support project by relative path.
