...
/// <summary>
///  Represents the OrderDeleteMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
///  A displayed order that was removed from the IEX Book
/// </remarks>
[DebuggerDisplay("{ToFormattedString(PrintOptions.Identifier),nq}")]
public sealed class OrderDeleteMessage : IMessage, IEquatable<OrderDeleteMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'R';
    ...
    /// </summary>
    public Reserved1Field Reserved1 { get; set; } = new();
    ...
    /// <summary>
    ///  Initializes a new <see cref="OrderDeleteMessage"/> with all fields at their default values.
    /// </summary>
    public OrderDeleteMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="OrderDeleteMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public OrderDeleteMessage(OrderDeleteMessage other) : this()
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other.Raw is { } raw) Raw = raw.ToArray();
        IsDecoded = other.IsDecoded;
        Reserved1.CopyFrom(other.Reserved1);
    ...
    /// <summary>
    ///  Parses a <see cref="OrderDeleteMessage"/> from a binary data span at the given offset.
    ...
    public OrderDeleteMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="OrderDeleteMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 25 bytes.</param>
    /// <returns>A new <see cref="OrderDeleteMessage"/> with all fields populated from the binary data.</returns>
    public static OrderDeleteMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new OrderDeleteMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="OrderDeleteMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 25 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="OrderDeleteMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    {
        offset = Reserved1.Encode(data, offset);
    ...
    /// <summary>
    ///  Encodes this <see cref="OrderDeleteMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="OrderDeleteMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static OrderDeleteMessage Sample()
    {
        var msg = new OrderDeleteMessage();
        msg.Reserved1 = Reserved1Field.Sample(seed: 0);
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="OrderDeleteMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="OrderDeleteMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(OrderDeleteMessage? other)
    {
        if (other is null) return false;
        if (!Reserved1.Equals(other.Reserved1)) return false;
    ...
    /// <summary>
    ///  Compares two <see cref="OrderDeleteMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is OrderDeleteMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="OrderDeleteMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(OrderDeleteMessage? a, OrderDeleteMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(OrderDeleteMessage? a, OrderDeleteMessage? b) => !(a == b);
    ...
    public readonly struct Changes : IEquatable<Changes>
    {
        ...
        public override string ToString()
        {
            ...
            var first = true;
            if (Has(0)) { if (!first) sb.Append(", "); sb.Append("Reserved1"); first = false; }
    ...
    public Changes Diff(OrderDeleteMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var diff = Changes.None;
        if (!Reserved1.Equals(other.Reserved1)) diff = diff.With(0);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not OrderDeleteMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(OrderDeleteMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
        var changes = Diff(other);
        if (changes.IsNone) yield break;
        if (changes.Has(0)) yield return (Reserved1.Name, Reserved1.ToFormattedString(), other.Reserved1.ToFormattedString());
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="OrderDeleteMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("OrderDeleteMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="OrderDeleteMessage"/>,
    ...
    public string ToFormattedString(PrintOptions options = default)
    {
        if (options.IsIdentifier)
            return $"[{MessageType}] [{Reserved1.Value}] [{Timestamp.Value}] [{Symbol.Value}]";
        if (options.IsCompact)
        {
            var sb = new StringBuilder();
            sb.Append("OrderDeleteMessage { ");
            bool first = true;
            foreach (var f in Fields)
            {
                if (!first) sb.Append(", ");
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="OrderDeleteMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="OrderDeleteMessage"/>.
    /// </summary>
