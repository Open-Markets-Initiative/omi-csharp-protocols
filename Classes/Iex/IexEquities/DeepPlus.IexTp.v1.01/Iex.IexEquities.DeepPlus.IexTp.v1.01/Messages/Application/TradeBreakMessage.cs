...
/// <summary>
///  Represents the TradeBreakMessage from the DeepPlus protocol.
/// </summary>
/// <remarks>
...
public sealed class TradeBreakMessage : IMessage, IEquatable<TradeBreakMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = 'B';
    ...
    /// <summary>
    ///  Initializes a new <see cref="TradeBreakMessage"/> with all fields at their default values.
    /// </summary>
    public TradeBreakMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="TradeBreakMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public TradeBreakMessage(TradeBreakMessage other) : this()
    {
    ...
    /// <summary>
    ///  Parses a <see cref="TradeBreakMessage"/> from a binary data span at the given offset.
    ...
    public TradeBreakMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="TradeBreakMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    /// <returns>A new <see cref="TradeBreakMessage"/> with all fields populated from the binary data.</returns>
    public static TradeBreakMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new TradeBreakMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="TradeBreakMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 37 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeBreakMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    /// <summary>
    ///  Encodes this <see cref="TradeBreakMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="TradeBreakMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static TradeBreakMessage Sample()
    {
        var msg = new TradeBreakMessage();
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="TradeBreakMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="TradeBreakMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(TradeBreakMessage? other)
    {
    ...
    /// <summary>
    ///  Compares two <see cref="TradeBreakMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is TradeBreakMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="TradeBreakMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(TradeBreakMessage? a, TradeBreakMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(TradeBreakMessage? a, TradeBreakMessage? b) => !(a == b);
    ...
    public Changes Diff(TradeBreakMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not TradeBreakMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(TradeBreakMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="TradeBreakMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("TradeBreakMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="TradeBreakMessage"/>,
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="TradeBreakMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="TradeBreakMessage"/>.
    /// </summary>
