...
public sealed class AdjustedPocPriceField : Field, IEquatable<AdjustedPocPriceField>, IComparable<AdjustedPocPriceField>
{
    public const int ByteLength = 8;
    public const bool IsLittleEndian = true;
    public const long Factor = 10000;

    public override string Name => "AdjustedPocPrice";
    ...
    public void CopyFrom(AdjustedPocPriceField other)
    {
    ...
    public static AdjustedPocPriceField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(AdjustedPocPriceField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is AdjustedPocPriceField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(AdjustedPocPriceField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(AdjustedPocPriceField? a, AdjustedPocPriceField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(AdjustedPocPriceField? a, AdjustedPocPriceField? b) => !(a == b);

    public static implicit operator decimal(AdjustedPocPriceField field) => field.Value;
    public static implicit operator AdjustedPocPriceField(decimal value) => new() { Value = value };

    public static bool operator ==(AdjustedPocPriceField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, AdjustedPocPriceField? b) => b is not null && b.Value == a;
    public static bool operator !=(AdjustedPocPriceField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, AdjustedPocPriceField? b) => !(a == b);

    public static bool operator <(AdjustedPocPriceField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, AdjustedPocPriceField? b) => b is not null && a < b.Value;
    public static bool operator >(AdjustedPocPriceField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, AdjustedPocPriceField? b) => b is not null && a > b.Value;
    public static bool operator <=(AdjustedPocPriceField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, AdjustedPocPriceField? b) => b is not null && a <= b.Value;
