...
public sealed class LowerAuctionCollarField : Field, IEquatable<LowerAuctionCollarField>, IComparable<LowerAuctionCollarField>
{
    public const int ByteLength = 8;
    public const bool IsLittleEndian = true;
    public const long Factor = 10000;

    public override string Name => "LowerAuctionCollar";
    ...
    public void CopyFrom(LowerAuctionCollarField other)
    {
    ...
    public static LowerAuctionCollarField Sample(int seed = 0) => new() { Value = 1m };

    public bool Equals(LowerAuctionCollarField? other) => other is not null && RawValue == other.RawValue;
    public override bool Equals(object? obj) => obj is LowerAuctionCollarField other && Equals(other);
    public override int GetHashCode() => RawValue.GetHashCode();

    public int CompareTo(LowerAuctionCollarField? other) => other is null ? 1 : RawValue.CompareTo(other.RawValue);

    public static bool operator ==(LowerAuctionCollarField? a, LowerAuctionCollarField? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(LowerAuctionCollarField? a, LowerAuctionCollarField? b) => !(a == b);

    public static implicit operator decimal(LowerAuctionCollarField field) => field.Value;
    public static implicit operator LowerAuctionCollarField(decimal value) => new() { Value = value };

    public static bool operator ==(LowerAuctionCollarField? a, decimal b) => a is not null && a.Value == b;
    public static bool operator ==(decimal a, LowerAuctionCollarField? b) => b is not null && b.Value == a;
    public static bool operator !=(LowerAuctionCollarField? a, decimal b) => !(a == b);
    public static bool operator !=(decimal a, LowerAuctionCollarField? b) => !(a == b);

    public static bool operator <(LowerAuctionCollarField? a, decimal b) => a is not null && a.Value < b;
    public static bool operator <(decimal a, LowerAuctionCollarField? b) => b is not null && a < b.Value;
    public static bool operator >(LowerAuctionCollarField? a, decimal b) => a is not null && a.Value > b;
    public static bool operator >(decimal a, LowerAuctionCollarField? b) => b is not null && a > b.Value;
    public static bool operator <=(LowerAuctionCollarField? a, decimal b) => a is not null && a.Value <= b;
    public static bool operator <=(decimal a, LowerAuctionCollarField? b) => b is not null && a <= b.Value;
