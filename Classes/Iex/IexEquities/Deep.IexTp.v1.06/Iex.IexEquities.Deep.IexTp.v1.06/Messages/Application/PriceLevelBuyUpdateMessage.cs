...
/// <summary>
///  Represents the PriceLevelBuyUpdateMessage from the Deep protocol.
/// </summary>
/// <remarks>
...
public sealed class PriceLevelBuyUpdateMessage : IMessage, IEquatable<PriceLevelBuyUpdateMessage>
{
    /// <summary>
    ///  Message type identifier.
    /// </summary>
    public const char MessageType = '8';
    ...
    /// <summary>
    ///  Initializes a new <see cref="PriceLevelBuyUpdateMessage"/> with all fields at their default values.
    /// </summary>
    public PriceLevelBuyUpdateMessage() { }

    /// <summary>
    ///  Initializes a new <see cref="PriceLevelBuyUpdateMessage"/> from an existing instance, copying all field values.
    /// </summary>
    /// <param name="other">The source instance to copy from.</param>
    public PriceLevelBuyUpdateMessage(PriceLevelBuyUpdateMessage other) : this()
    {
    ...
    /// <summary>
    ///  Parses a <see cref="PriceLevelBuyUpdateMessage"/> from a binary data span at the given offset.
    ...
    public PriceLevelBuyUpdateMessage(ReadOnlySpan<byte> data, ref int offset)
    {
        var start = offset;
        var decoded = true;
    ...
    /// <summary>
    ///  Parses a <see cref="PriceLevelBuyUpdateMessage"/> from a binary data span.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 29 bytes.</param>
    /// <returns>A new <see cref="PriceLevelBuyUpdateMessage"/> with all fields populated from the binary data.</returns>
    public static PriceLevelBuyUpdateMessage Parse(ReadOnlySpan<byte> data)
    {
        var offset = 0;
        return new PriceLevelBuyUpdateMessage(data, ref offset);
    }

    /// <summary>
    ///  Parses binary data into this <see cref="PriceLevelBuyUpdateMessage"/> instance in place, reusing existing field objects.
    /// </summary>
    /// <param name="data">The raw message bytes. Must contain at least 29 bytes.</param>
    ...
    /// <summary>
    ///  Encodes this <see cref="PriceLevelBuyUpdateMessage"/> into a binary data span starting at the given offset.
    /// </summary>
    ...
    /// <summary>
    ///  Encodes this <see cref="PriceLevelBuyUpdateMessage"/> into a binary data span starting at offset 0.
    /// </summary>
    ...
    /// <summary>
    ///  Returns a <see cref="PriceLevelBuyUpdateMessage"/> with deterministic sample values in every field,
    ///  suitable for round-trip encoding tests.
    /// </summary>
    public static PriceLevelBuyUpdateMessage Sample()
    {
        var msg = new PriceLevelBuyUpdateMessage();
    ...
    /// <summary>
    ///  Resets all fields of this <see cref="PriceLevelBuyUpdateMessage"/> to their default values and clears the raw backing store.
    /// </summary>
    public void Clear()
    {
        Raw = null;
    ...
    /// <summary>
    ///  Compares this <see cref="PriceLevelBuyUpdateMessage"/> to another using field-by-field comparison.
    /// </summary>
    public bool Equals(PriceLevelBuyUpdateMessage? other)
    {
    ...
    /// <summary>
    ///  Compares two <see cref="PriceLevelBuyUpdateMessage"/> instances field by field.
    /// </summary>
    public override bool Equals(object? obj)
    {
        return obj is PriceLevelBuyUpdateMessage other && Equals(other);
    }
    ...
    /// <summary>
    ///  Returns a hash code for this <see cref="PriceLevelBuyUpdateMessage"/> by combining the hash of each field and counted-group container.
    /// </summary>
    ...
    public static bool operator ==(PriceLevelBuyUpdateMessage? a, PriceLevelBuyUpdateMessage? b) => ReferenceEquals(a, b) || (a is not null && a.Equals(b));
    public static bool operator !=(PriceLevelBuyUpdateMessage? a, PriceLevelBuyUpdateMessage? b) => !(a == b);
    ...
    public Changes Diff(PriceLevelBuyUpdateMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    {
        ArgumentNullException.ThrowIfNull(other);
        if (other is not PriceLevelBuyUpdateMessage typed) throw new ArgumentException("DiffFields requires same message type", nameof(other));
    ...
    public IEnumerable<(string Name, string Before, string After)> DiffReport(PriceLevelBuyUpdateMessage other)
    {
        ArgumentNullException.ThrowIfNull(other);
    ...
    /// <summary>
    ///  Appends a human-readable representation of all fields in this <see cref="PriceLevelBuyUpdateMessage"/> to <paramref name="builder"/>,
    ...
    public void ToFormattedString(StringBuilder builder, PrintOptions options = default)
    {
        ...
        builder.Append(indent).AppendLine("PriceLevelBuyUpdateMessage:");
        foreach (var f in Fields)
        {
    ...
    /// <summary>
    ///  Returns a human-readable representation of all fields in this <see cref="PriceLevelBuyUpdateMessage"/>,
    ...
    public string ToFormattedString(PrintOptions options = default)
    {
        ...
        if (options.IsCompact)
        {
            ...
            sb.Append("PriceLevelBuyUpdateMessage { ");
            bool first = true;
            foreach (var f in Fields)
            {
                if (!first) sb.Append(", ");
    ...
    /// <summary>
    ///  Returns a compact one-line representation of all fields in this <see cref="PriceLevelBuyUpdateMessage"/>.
    /// </summary>
    public string ToCompact() => ToFormattedString(PrintOptions.Compact);

    /// <summary>
    ///  Returns a human-readable representation of this <see cref="PriceLevelBuyUpdateMessage"/>.
    /// </summary>
